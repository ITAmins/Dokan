...
public class PdfExporter {
    ...
    public static File exportPeriodReportToPdf(Context context, String periodTitle, double totalSale, double totalExpense, double totalProfit, List<MainViewModel.DaySummary> summaries) {
        PdfDocument document = new PdfDocument();
        int pageWidth = 595;
        int pageHeight = 842;
        ...
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        canvas.drawText("মাওয়া স্টোর - " + periodTitle, 30, 42, paint);
        ...
        int y = 110;
        paint.setColor(Color.parseColor("#F8FAFC"));
        canvas.drawRoundRect(30, y, pageWidth - 30, y + 80, 10, 10, paint);
        paint.setColor(Color.parseColor("#CBD5E1"));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(1);
        canvas.drawRoundRect(30, y, pageWidth - 30, y + 80, 10, 10, paint);
        ...
        paint.setTextSize(13);
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        canvas.drawText("সার্বিক আর্থিক চিত্র:", 45, y + 26, paint);

        paint.setTextSize(11.5f);
        paint.setTypeface(Typeface.DEFAULT);
        paint.setColor(Color.parseColor("#475569"));
        canvas.drawText("মোট বিক্রি: ৳ " + formatBengaliNumber(totalSale), 45, y + 54, paint);
        canvas.drawText("মোট খরচ: ৳ " + formatBengaliNumber(totalExpense), 230, y + 54, paint);
        paint.setColor(Color.parseColor("#15803D"));
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        canvas.drawText("আনুমানিক লাভ: ৳ " + formatBengaliNumber(totalProfit), 400, y + 54, paint);

        y += 105;
        paint.setColor(Color.parseColor("#1E293B"));
        paint.setTextSize(14);
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        canvas.drawText("দৈনিক হিসাবের বিস্তারিত খতিয়ান:", 30, y, paint);

        y += 24;
        paint.setTextSize(11);
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        paint.setColor(Color.parseColor("#475569"));
        canvas.drawText("তারিখ", 35, y, paint);
        canvas.drawText("হাতে ক্যাশ (৳)", 125, y, paint);
        canvas.drawText("খরচ (৳)", 225, y, paint);
        canvas.drawText("সাবেক (৳)", 315, y, paint);
        canvas.drawText("নিট বিক্রি (৳)", 405, y, paint);
        canvas.drawText("লাভ (৳)", pageWidth - 75, y, paint);
        ...
        if (summaries != null && !summaries.isEmpty()) {
            for (MainViewModel.DaySummary ds : summaries) {
                ...
                canvas.drawText(ds.dateKey != null ? ds.dateKey : "-", 35, y, paint);
                canvas.drawText(formatBengaliNumber(ds.availableCash), 125, y, paint);
                canvas.drawText(formatBengaliNumber(ds.expenses), 225, y, paint);
                canvas.drawText(formatBengaliNumber(ds.sabek), 315, y, paint);

                paint.setColor(Color.parseColor("#15803D"));
                paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
                canvas.drawText(formatBengaliNumber(ds.computedSale), 405, y, paint);

                paint.setColor(Color.parseColor("#0284C7"));
                canvas.drawText(formatBengaliNumber(ds.estimatedProfit), pageWidth - 75, y, paint);
            ...
            canvas.drawText("কোন হিসাব তালিকা পাওয়া যায়নি", 35, y, paint);
        }

        paint.setColor(Color.parseColor("#94A3B8"));
        paint.setTextSize(10);
        paint.setTypeface(Typeface.DEFAULT);
        canvas.drawText("মাওয়া স্টোর ডিজিটাল অ্যাপ দ্বারা তৈরিকৃত প্রতিবেদন", 30, pageHeight - 20, paint);
        ...
        File outputFile = new File(outputDir, "MawaStore_Report_" + cleanTitle + "_" + System.currentTimeMillis() + ".pdf");
