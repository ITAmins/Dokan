...
public class SupabaseAuthManager {
    ...
    private SupabaseAuthManager(Context context) {
        ...
        String url = "https://pkpcfksbslbileordrqs.supabase.co";
        String key = "sb_publishable_Tp8GPJO0_ee3FpITfqes1A_DMn2BZJO";

        try {
            // Check BuildConfig if provided via secrets gradle plugin
        ...
        if (key == null || key.trim().isEmpty()) {
            key = "sb_publishable_Tp8GPJO0_ee3FpITfqes1A_DMn2BZJO";
        }
    ...
    public static String translateError(String rawError) {
        ...
        if (lower.contains("invalid login credentials") || lower.contains("invalid credentials") || lower.contains("invalid_grant")) {
            return "ইমেইল অথবা পাসওয়ার্ড সঠিক নয়, অথবা ইমেইল কনফার্ম করা হয়নি। (Supabase ড্যাশবোর্ডে Authentication -> Providers -> Email থেকে 'Confirm email' বন্ধ রয়েছে কি না চেক করুন)।";
        }
        if (lower.contains("email not confirmed") || lower.contains("email_not_confirmed")) {
            return "আপনার ইমেইলটি এখনও কনফার্ম করা হয়নি। দয়া করে আপনার ইনবক্স চেক করে কনফার্ম করুন অথবা Supabase ড্যাশবোর্ডে 'Confirm email' বন্ধ করুন।";
        }
