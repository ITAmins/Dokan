        ...
        try {
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                if (arr != null && arr.size() > 0) {
                    ...
                    JsonObject cloudData = null;
                    if (latestBackup.has("backup_data") && !latestBackup.get("backup_data").isJsonNull()) {
                        cloudData = latestBackup.getAsJsonObject("backup_data");
                    } else if (latestBackup.has("data") && !latestBackup.get("data").isJsonNull()) {
