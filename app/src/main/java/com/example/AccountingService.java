...
public class AccountingService {
    ...
    public DailyAccountingSummary calculateDailySummary(String dateKey) {
        ...
        // 8. Estimated Profit Calculation (টাকার ওপর শতকরা লাভ হিসাব)
        ...
        // Business purchases and store cash stay inside the business cycle, so profit is percentage on turnover
        summary.estimatedBusinessProfit = summary.estimatedGrossProfit;
        summary.estimatedNetProfit = summary.estimatedGrossProfit;
        // Profit remaining after home withdrawals (if any)
        summary.profitRemaining = summary.estimatedGrossProfit - summary.totalHomeExpenses;
